/**
 * Social brand marks (GitHub, LinkedIn, X/Twitter).
 *
...
export function GithubIcon({ size = 18, className = "" }: SocialIconProps): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
...
export function LinkedinIcon({ size = 18, className = "" }: SocialIconProps): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
...
export function TwitterIcon({ size = 18, className = "" }: SocialIconProps): React.JSX.Element {
  return (
    <svg
      width={size}
      height={size}
